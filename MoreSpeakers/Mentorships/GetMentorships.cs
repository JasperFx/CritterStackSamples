...
public static class GetMentorshipsForMentorEndpoint
{
    ...
    public static Task<IReadOnlyList<Mentorship>> Get(Guid mentorId, IQuerySession session)
...
public static class GetMentorshipsForMenteeEndpoint
{
    ...
    public static Task<IReadOnlyList<Mentorship>> Get(Guid menteeId, IQuerySession session)
        => session.Query<Mentorship>()
