...
// Imperative command records — the operator/driver intent that flows into TripService.
// (CritterWatch convention: commands are imperative, events are past-tense.)
...
public record TripMaintenanceCheck(Guid TripId);
