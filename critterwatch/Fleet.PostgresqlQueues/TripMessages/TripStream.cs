...
/// trip; the publisher dequeues one command at a time and dispatches it over the Wolverine PostgreSQL
/// queue transport. TripService handles each command, its projection publishes <see cref="ContinueTrip"/>
/// back, and the publisher advances to the next message — a self-driving loop that keeps steady-state
/// traffic flowing.
/// </summary>
