...
/// <summary>
/// Multi-stream Polecat projection that groups events across every trip by day, fanning the child
/// <see cref="Movement"/> / <see cref="Stop"/> collections of each <see cref="Traveled"/> event out as if
/// they were individual events. A good demo of grouping + fan-out, and a non-trivial rebuild target for
/// the CritterWatch rebuild UI.
/// </summary>
public partial class DayProjection : MultiStreamProjection<Day, int>
{
    public DayProjection()
    {
        ...
        FanOut<Traveled, Stop>(x => x.Stops);
