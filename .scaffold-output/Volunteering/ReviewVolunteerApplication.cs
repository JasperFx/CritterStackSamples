...
{
    public static ProblemDetails Validate(ReviewVolunteerApplication command, VolunteerApplication volunteerApplication)
    {
    ...
    public static EventsToAppend Post(ReviewVolunteerApplication command, [WriteModel] VolunteerApplication volunteerApplication)
    {
        ...
        //     return [new VolunteerApplicationReviewed(/* … */)];
        throw new NotImplementedException("TODO: ReviewVolunteerApplication — decide which events this slice appends");
    }
